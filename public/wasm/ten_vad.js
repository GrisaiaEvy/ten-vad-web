...
var createVADModule = (() => {
  // 兼容性处理：如果 import.meta 不可用，使用 document.currentScript
  var _scriptDir;
  try {
    _scriptDir = import.meta.url;
  } catch (e) {
    // 回退到 document.currentScript
